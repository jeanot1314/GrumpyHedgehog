...
void HH_look_left_right(int horizontal) {
  ...
  int pause = 1000;
  if (horizontal > 0) {
    for (int i = 0; i <= horizontal; i = i + sp) {

      for (int k = 0; k < sp; k++) {
        tft.drawCircleHelper(EYES_1_HORIZONTAL_POSITION + i + k, EYES_VERTICAL_POSITION, EYES_SIZE, 1,  ST77XX_BLACK);
        tft.drawCircleHelper(EYES_1_HORIZONTAL_POSITION + i + k, EYES_VERTICAL_POSITION, EYES_SIZE, 8,  ST77XX_BLACK);
        tft.drawPixel(EYES_1_HORIZONTAL_POSITION + i + k - EYES_SIZE, EYES_VERTICAL_POSITION, ST77XX_BLACK);
      }
      if (i >= horizontal - sp){
        tft.fillCircle(EYES_1_HORIZONTAL_POSITION + i, EYES_VERTICAL_POSITION, EYES_SIZE, EYES_COLOR);
      }
      else{
        tft.fillCircle(EYES_1_HORIZONTAL_POSITION + i + sp, EYES_VERTICAL_POSITION, EYES_SIZE, EYES_COLOR);
      }

      for (int k = 0; k < sp; k++) {
        tft.drawCircleHelper(EYES_2_HORIZONTAL_POSITION + i + k, EYES_VERTICAL_POSITION, EYES_SIZE, 1,  ST77XX_BLACK);
        tft.drawCircleHelper(EYES_2_HORIZONTAL_POSITION + i + k, EYES_VERTICAL_POSITION, EYES_SIZE, 8,  ST77XX_BLACK);
        tft.drawPixel(EYES_2_HORIZONTAL_POSITION + i + k - EYES_SIZE, EYES_VERTICAL_POSITION, ST77XX_BLACK);
      }
      if (i >= horizontal - sp)
        tft.fillCircle(EYES_2_HORIZONTAL_POSITION + i, EYES_VERTICAL_POSITION, EYES_SIZE, EYES_COLOR);
      else
        tft.fillCircle(EYES_2_HORIZONTAL_POSITION + i + sp, EYES_VERTICAL_POSITION, EYES_SIZE, EYES_COLOR);

      for (int k = 0; k < sp / 2; k++) {
        tft.drawCircleHelper(NOSE_HORIZONTAL_POSITION + i / 2 + k - 2, NOSE_VERTICAL_POSITION, NOSE_SIZE, 1,  ST77XX_BLACK);
        tft.drawCircleHelper(NOSE_HORIZONTAL_POSITION + i / 2 + k - 2, NOSE_VERTICAL_POSITION, NOSE_SIZE, 8,  ST77XX_BLACK);
        tft.drawPixel(NOSE_HORIZONTAL_POSITION + i / 2 + k - 2 - NOSE_SIZE, NOSE_VERTICAL_POSITION, ST77XX_BLACK);
      }
      tft.fillCircle(NOSE_HORIZONTAL_POSITION + i / 2 + sp / 2, NOSE_VERTICAL_POSITION, NOSE_SIZE, NOSE_COLOR);
      tft.fillCircle(NOSE_HORIZONTAL_POSITION + i + sp / 2, NOSE_VERTICAL_POSITION, NOSE_DOT_SIZE, ST77XX_BLACK);

      delay(delay_slow);
    }
    delay(pause);
    for (int i = horizontal; i >= 0; i = i - sp) {
      for (int k = 0; k < sp; k++) {
        tft.drawCircleHelper(EYES_1_HORIZONTAL_POSITION + i - k, EYES_VERTICAL_POSITION, EYES_SIZE, 2,  ST77XX_BLACK);
        tft.drawCircleHelper(EYES_1_HORIZONTAL_POSITION + i - k, EYES_VERTICAL_POSITION, EYES_SIZE, 4,  ST77XX_BLACK);
        tft.drawPixel(EYES_1_HORIZONTAL_POSITION + i - k + EYES_SIZE, EYES_VERTICAL_POSITION, ST77XX_BLACK);
      }
      if (i == 0)
        tft.fillCircle(EYES_1_HORIZONTAL_POSITION + i, EYES_VERTICAL_POSITION, EYES_SIZE, EYES_COLOR);
      ...
      for (int k = 0; k < sp; k++) {
        tft.drawCircleHelper(EYES_2_HORIZONTAL_POSITION + i - k, EYES_VERTICAL_POSITION, EYES_SIZE, 2,  ST77XX_BLACK);
        tft.drawCircleHelper(EYES_2_HORIZONTAL_POSITION + i - k, EYES_VERTICAL_POSITION, EYES_SIZE, 4,  ST77XX_BLACK);
        tft.drawPixel(EYES_2_HORIZONTAL_POSITION + i - k + EYES_SIZE, EYES_VERTICAL_POSITION, ST77XX_BLACK);
      }
      if (i == 0)
        tft.fillCircle(EYES_2_HORIZONTAL_POSITION + i, EYES_VERTICAL_POSITION, EYES_SIZE, EYES_COLOR);
      ...
      for (int k = 0; k < sp / 2; k++) {
        tft.drawCircleHelper(NOSE_HORIZONTAL_POSITION + i / 2 - k + 2, NOSE_VERTICAL_POSITION, NOSE_SIZE, 2,  ST77XX_BLACK);
        tft.drawCircleHelper(NOSE_HORIZONTAL_POSITION + i / 2 - k + 2, NOSE_VERTICAL_POSITION, NOSE_SIZE, 4,  ST77XX_BLACK);
        tft.drawPixel(NOSE_HORIZONTAL_POSITION + i / 2 - k + 2 + NOSE_SIZE, NOSE_VERTICAL_POSITION, ST77XX_BLACK);
      }
      tft.fillCircle(NOSE_HORIZONTAL_POSITION + i / 2 - sp / 2, NOSE_VERTICAL_POSITION, NOSE_SIZE, NOSE_COLOR);
      tft.fillCircle(NOSE_HORIZONTAL_POSITION + i + sp / 2, NOSE_VERTICAL_POSITION, NOSE_DOT_SIZE, ST77XX_BLACK);
...
void HH_look_up_down(int vertical) {
  ...
  int pause = 1000;
  if (vertical > 0) {
    for (int i = 0; i <= vertical; i = i + sp) {

      for (int k = 0; k < sp; k++) {
        tft.drawCircleHelper(EYES_1_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION + i + k, EYES_SIZE, 1,  ST77XX_BLACK);
        tft.drawCircleHelper(EYES_1_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION + i +k, EYES_SIZE, 2,  ST77XX_BLACK);
        tft.drawPixel(EYES_1_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION + i + k - EYES_SIZE, ST77XX_BLACK);
      }
      if (i >= vertical - sp)
        tft.fillCircle(EYES_1_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION+i, EYES_SIZE, EYES_COLOR);
      else
        tft.fillCircle(EYES_1_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION + i + sp, EYES_SIZE, EYES_COLOR);

      for (int k = 0; k < sp; k++) {
        tft.drawCircleHelper(EYES_2_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION + i + k, EYES_SIZE, 1,  ST77XX_BLACK);
        tft.drawCircleHelper(EYES_2_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION + i + k, EYES_SIZE, 2,  ST77XX_BLACK);
        tft.drawPixel(EYES_2_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION + i + k - EYES_SIZE, ST77XX_BLACK);
      }
      if (i >= vertical - sp)
        tft.fillCircle(EYES_2_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION + i, EYES_SIZE, EYES_COLOR);
      else
        tft.fillCircle(EYES_2_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION + i + sp, EYES_SIZE, EYES_COLOR);

      for (int k = 0; k < sp / 2; k++) {
        tft.drawCircleHelper(NOSE_HORIZONTAL_POSITION, NOSE_VERTICAL_POSITION + i / 2 + k - 2, NOSE_SIZE, 1,  ST77XX_BLACK);
        tft.drawCircleHelper(NOSE_HORIZONTAL_POSITION, NOSE_VERTICAL_POSITION + i / 2 + k - 2, NOSE_SIZE, 2,  ST77XX_BLACK);
        tft.drawPixel(NOSE_HORIZONTAL_POSITION, NOSE_VERTICAL_POSITION + i / 2 + k - 2 - NOSE_SIZE, ST77XX_BLACK);
      }
      tft.fillCircle(NOSE_HORIZONTAL_POSITION, NOSE_VERTICAL_POSITION + i / 2 + sp / 2, NOSE_SIZE, NOSE_COLOR);
      tft.fillCircle(NOSE_HORIZONTAL_POSITION, NOSE_VERTICAL_POSITION + i + sp / 2, NOSE_DOT_SIZE, ST77XX_BLACK);

      delay(delay_slow);
    }
    delay(pause);
    for (int i = vertical; i >= 0; i = i - sp) {
      for (int k = 0; k < sp; k++) {
        tft.drawCircleHelper(EYES_1_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION + i - k, EYES_SIZE, 4,  ST77XX_BLACK);
        tft.drawCircleHelper(EYES_1_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION + i - k, EYES_SIZE, 8,  ST77XX_BLACK);
        tft.drawPixel(EYES_1_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION + i - k + EYES_SIZE, ST77XX_BLACK);
      }
      if (i == 0)
        tft.fillCircle(EYES_1_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION + i, EYES_SIZE, EYES_COLOR);
      ...
      for (int k = 0; k < sp; k++) {
        tft.drawCircleHelper(EYES_2_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION + i - k, EYES_SIZE, 4,  ST77XX_BLACK);
        tft.drawCircleHelper(EYES_2_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION + i - k, EYES_SIZE, 8,  ST77XX_BLACK);
        tft.drawPixel(EYES_2_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION + i - k + EYES_SIZE, ST77XX_BLACK);
      }
      if (i == 0)
        tft.fillCircle(EYES_2_HORIZONTAL_POSITION, EYES_VERTICAL_POSITION + i, EYES_SIZE, EYES_COLOR);
      ...
      for (int k = 0; k < sp / 2; k++) {
        tft.drawCircleHelper(NOSE_HORIZONTAL_POSITION, NOSE_VERTICAL_POSITION + i / 2 - k + 2, NOSE_SIZE, 4,  ST77XX_BLACK);
        tft.drawCircleHelper(NOSE_HORIZONTAL_POSITION, NOSE_VERTICAL_POSITION + i / 2 - k + 2, NOSE_SIZE, 8,  ST77XX_BLACK);
        tft.drawPixel(NOSE_HORIZONTAL_POSITION, NOSE_VERTICAL_POSITION + i / 2 - k + 2 + NOSE_SIZE, ST77XX_BLACK);
      }
      tft.fillCircle(NOSE_HORIZONTAL_POSITION, NOSE_VERTICAL_POSITION + i / 2 - sp / 2, NOSE_SIZE, NOSE_COLOR);
      tft.fillCircle(NOSE_HORIZONTAL_POSITION, NOSE_VERTICAL_POSITION + i + sp / 2, NOSE_DOT_SIZE, ST77XX_BLACK);
...
void HH_nose(bool present, int horizontal, int vertical) {
  ...
  if (present == 1) {
    ...
    tft.fillCircle(tft.width() / 2 + horizontal - 5, NOSE_VERTICAL_POSITION - 5 + 3 * vertical / 2, NOSE_DOT_SIZE, ST77XX_BLACK);
    tft.fillCircle(tft.width() / 2 + horizontal, NOSE_VERTICAL_POSITION - 5 + 3 * vertical / 2, NOSE_DOT_SIZE + 1, ST77XX_BLACK);
    tft.fillCircle(tft.width() / 2 + horizontal + 5, NOSE_VERTICAL_POSITION - 5 + 3 * vertical / 2, NOSE_DOT_SIZE, ST77XX_BLACK);
  }
  else {
...
void nose_picture_bear(bool visible) {
  if (visible) {
    ...
    tft.fillRect(3 * (tft.width()) / 10, 40, 49, 63, ST77XX_BLACK);
  }
}
